 ...
 * Original file: /npm/slugify@1.6.6/slugify.js
 *
...
!(function (e, a, o) {
  ...
  function o(o, n) {
    ...
    var r =
        a[(n = "string" == typeof n ? { replacement: n } : n || {}).locale] ||
        {},
      i = void 0 === n.replacement ? "-" : n.replacement,
      t = void 0 === n.trim || n.trim,
      u = o
        .normalize()
        .split("")
        .reduce(function (a, o) {
          ...
          return (
            ...
            void 0 === t && (t = o),
            t === i && (t = " "),
            a + t.replace(n.remove || /[^\w\s$*_+~.()'"!\-:@]+/g, "")
          );
        }, "");
    return (
      n.strict && (u = u.replace(/[^A-Za-z0-9\s]/g, "")),
      t && (u = u.trim()),
      (u = u.replace(/\s+/g, i)),
      n.lower && (u = u.toLowerCase()),
      u
    );
  }
  return (
...
//# sourceMappingURL=/sm/69d569b95b6cfd595c2186547d9d7497cb1ac2392b71f77d53ac49ea551ff5b4.map
1;
